...
- [Phase 3 browser test hardening v2](phase-3-browser-hardening-v2.md) — 3 root causes + independent reviewer blockers resolved; trace.zip capture pattern; drizzle-kit upgrade proof methodology
