...
const tiers = [
  {
    ...
    highlight: false,
    badge: null,
    cta: { label: 'Get Started', plan: 'Starter' },
    features: [
      'Up to 10 beds',
  ...
  },
  {
    ...
    highlight: true,
    badge: 'Most Popular',
    cta: { label: 'Book a Demo', plan: 'Growth' },
    features: [
      'Up to 40 beds',
      'Unlimited clinical staff logins',
  ...
  },
  {
    ...
    highlight: false,
    badge: null,
    cta: { label: 'Contact Sales', plan: 'Enterprise' },
    features: [
...
export const Pricing = () => {
  ...
  return (
    <>
      <section id="pricing" className="py-28">
        <div className="container mx-auto px-5 md:px-10">
          ...
          <div className="grid md:grid-cols-3 gap-5 max-w-5xl mx-auto items-stretch">
            {tiers.map((tier, i) => (
              ...
              >
                ...
                <button
                  onClick={() => openDemo(tier.cta.plan)}
          ...
          >
            ...
            <button
              onClick={() => openDemo('Enterprise')}
              className="text-sunrise-orange hover:text-orange-400 transition-colors"
            >
              Talk to sales
            </button>{' '}
            for a custom quote.
      ...
      <DemoModal open={demoOpen} onClose={() => setDemoOpen(false)} defaultPlan={selectedPlan} />
    </>
  );
};
