...
export const Footer = () => {
  ...
  const navColumns = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'BAA Available', modal: true },
      ],
    },
  ];
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-5 md:px-10 py-14">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              {/* Display-only email — kept as mailto so visitors can copy/click the address */}
              <a
      ...
      <DemoModal open={demoOpen} onClose={() => setDemoOpen(false)} defaultPlan="Contact" />
    </>
  );
};
