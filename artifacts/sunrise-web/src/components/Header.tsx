      ...
      <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-400">
          ...
          <a
            ...
            className="ml-6 inline-flex items-center justify-center px-5 py-2 text-sm font-semibold text-white bg-sunrise-orange hover:bg-orange-500 rounded-lg transition-colors whitespace-nowrap"
          >
            Book a Demo
          </a>
        </div>
