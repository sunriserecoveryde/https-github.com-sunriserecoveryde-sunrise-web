...
export const MOCK_PATIENTS: Patient[] = [
  {
    ...
    craving: 8,
    notes: [
      { id: 'n1', date: '2026-07-25 14:30', type: 'Individual', author: 'Sarah Jenkins, LCPC', status: 'Signed', format: 'BIRP', content: 'Client attended 1:1 session. Expressed high cravings and desire to leave AMA. Processed consequences of leaving. Client agreed to stay for next 24 hours.' },
  ...
  },
  {
    ...
    counselor: 'Maria Gonzales, LCADC',
    physician: 'Dr. Emily Stone',
    flags: [
...
MOCK_PATIENTS.push(
  {
    ...
    counselor: 'Maria Gonzales, LCADC', physician: 'Dr. Allen Hughes',
  ...
  },
  {
    ...
    counselor: 'David Odom, LCADC', physician: 'Dr. Robert Chen',
  ...
  },
  {
    ...
    counselor: 'Sarah Jenkins, LCPC', physician: 'Dr. Robert Chen',
  ...
  },
  {
    ...
    counselor: 'David Odom, LCADC', physician: 'Dr. Emily Stone',
  ...
  },
  {
    ...
    counselor: 'Sarah Jenkins, LCPC', physician: 'Dr. Allen Hughes',
  ...
  },
  {
    ...
    counselor: 'Sarah Jenkins, LCPC', physician: 'Dr. Emily Stone',
  ...
  },
  {
    ...
    counselor: 'Maria Gonzales, LCADC', physician: 'Dr. Emily Stone',
    flags: [
  ...
  },
  {
    ...
    notes: [{ id: 'n25a', date: '2026-07-14', type: 'Individual', author: 'David Odom, LCADC', status: 'Signed', format: 'DAP', content: 'Final week of IOP. Client in exceptional shape — mood 9/10, cravings nearly absent. HIV viral load undetectable; infectious disease team satisfied. Employment restored: returning to logistics coordinator role next week. Five-year chip ceremony planned at AA home group. Discharge summary initiated; outpatient therapy with Dr. Patel confirmed. Outstanding outcome.' }],
    goals: [
  ...
  // ── Demo patient — IOP pending intake for live walkthroughs ──────────────
  {
    ...
    counselor: 'Sarah Jenkins, LCPC, CAC-AD',
    physician: 'Dr. Emily Stone',
    flags: [
