...
export function DemoBanner() {
  ...
  return (
    <div className="h-[var(--banner-height)] w-full bg-gradient-to-r from-purple to-indigo-600 flex items-center justify-between px-4 fixed top-0 left-0 z-50 text-white shadow-sm">
