...
const ALL_SCREEN_SHORTCUTS: { label: string; screen: Screen; icon: React.ReactNode; category: string }[] = [
  ...
  { label: 'Admissions / Intake',        screen: 'Admissions',              icon: <User className="w-4 h-4" />,             category: 'Scheduling, Intake & Admissions' },
  { label: 'Admissions Screening',       screen: 'ClinicalForms',           icon: <User className="w-4 h-4" />,             category: 'Scheduling, Intake & Admissions' },
