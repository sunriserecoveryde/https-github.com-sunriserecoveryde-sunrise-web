          ...
          <div className="card p-0 overflow-hidden">
            ...
            <div className="divide-y divide-border">
              {[
                ...
                { time: '08:30', type: 'Family Call', from: 'D. Odom, LCADC', to: 'Family of M. Webb', subject: 'Weekly family check-in call (consent on file)', outcome: 'Mother updated on treatment progress — no clinical details shared. Alumni program discussed.', priority: 'Routine' },
                ...
                { time: '10:15', type: 'Interdisciplinary', from: 'S. Jenkins, LCPC', to: 'J. Torres, RN + D. Odom, LCADC', subject: 'Patient S. Choi — treatment team discussion re: safety plan update needed', outcome: 'Safety plan updated. Counselor to file updated safety plan in chart by EOD.', priority: 'High' },
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            {[
              ...
              { id: 'ai2', priority: 'Critical', title: 'Robert Navarro — positive UDS confrontation must be documented before physician rounds', patient: 'Robert Navarro', assignedTo: 'Sarah Jenkins, LCPC', due: '20:00', status: 'Overdue', source: 'UDS Protocol' },
              ...
              { id: 'ai4', priority: 'High', title: 'Elena Vasquez — safety plan review with family (wife). 42 CFR consent on file?', patient: 'Elena Vasquez', assignedTo: 'Maria Gonzales, LCADC', due: '09:00 (tomorrow)', status: 'Open', source: 'Risk Protocol' },
              ...
              { id: 'ai7', priority: 'Medium', title: 'Patricia Holloway — family meeting rescheduled to 7/24 3PM. Update calendar.', patient: 'Patricia Holloway', assignedTo: 'David Odom, LCADC', due: 'Tomorrow', status: 'In Progress', source: 'Family Engagement' },
