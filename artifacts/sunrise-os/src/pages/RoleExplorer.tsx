        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-xs">
            {[
              ...
              { role: 'CAC-AD / CAADC', cred: 'CAC-AD, CAADC', scope: 'Substance use counseling, group facilitation, 12-step facilitation, case management under clinical supervision.', doc: 'Progress notes, group notes under supervision. CAADC may write more independently than CAC-AD per MD BHA guidelines.', screens: 'Documentation, groups, caseload — supervised' },
