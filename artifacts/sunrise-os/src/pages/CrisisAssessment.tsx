...
const CSSRS_RECORDS: CSSRSRecord[] = [
  {
    ...
    clinicianNotified: 'James S. Collins III, CAC-AD (Clinical Director) — notified 7/18 at 2:30 PM',
    interventions: [
  ...
  },
  {
    ...
    safetyPlanCompleted: true,
    meansRestrictionCounseled: true,
    clinicianNotified: 'Dr. Emma Hughes, MD (Psychiatrist) — paged at 11:15 PM 7/17; James S. Collins III — notified 7:00 AM 7/18',
    interventions: [
  ...
  },
  {
    ...
    safetyPlanItems: [
      ...
      'Professional support: David Odom LCADC, on-call staff',
          ...
          {[
            {
              ...
              facilitator: 'James S. Collins III, PhD',
              staffPresent: ['J. Torres, RN', 'D. Odom, LCADC', 'R. Davis, BHT', 'K. Smith, BHT'],
              summary: 'Patient escalated during afternoon group session following a perceived interpersonal conflict with a peer. BHT R. Davis de-escalated effectively using verbal redirection. Security protocols followed. Patient isolated in room 12 and LCADC D. Odom provided immediate 1:1 de-escalation support.',
              ...
              actions: [
                { item: 'Review group assignment policy for conflict-adjacent patients', owner: 'S. Jenkins, LCPC', due: '2026-07-24', done: true },
            ...
            },
            {
              ...
              facilitator: 'James S. Collins III, PhD',
              staffPresent: ['Dr. Robert Chen', 'J. Torres, RN', 'S. Jenkins, LCPC', 'A. Patel, RN'],
              ...
              actions: [
                { item: 'Add trauma anniversary flag to patient intake assessment', owner: 'S. Jenkins, LCPC', due: '2026-07-18', done: true },
              ...
              <table className="w-full text-xs">
                ...
                <tbody className="divide-y divide-border">
                  {[
                    ...
                    { name: 'A. Brooks, LCPC', cpi: true, qpr: true, mandt: true, exp: '2026-09', ok: false },
