...
const DEMO_DATA: Record<string, string> = {
  ...
  substancesTreatment: 'Inpatient detox x1 (2019, Shady Grove Medical Center, opioid withdrawal). Residential x1 (2021, 28 days, completed, relapsed at 8 months). No MAT history. Not currently prescribed MAT. Patient open to Suboxone.',
...
Z63.0  — Relationship Distress with Spouse or Intimate Partner`,
  ...
  assessmentCompleted: 'Assessment completed by Sarah Jenkins, LCPC, CAC-AD (Primary Counselor) with co-assessment by James S. Collins III, CAC-AD, BAS (Clinical Supervisor). Reviewed and signed by Dr. Robert Chen, MD (Medical Director).',
};
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-1 border-b border-border">
        {(['Assessment', 'Population Summary', 'SUD Epidemiology', 'Diagnostic Coding', 'Assessment Quality', 'Screening Tools'] as const).map(t => (
...
function AssessmentQualityTab() {
  const metrics = [
    { clinician: 'A. Brooks, LCPC', completed: 12, avgDays: 1.1, sigRate: '100%', score: 96, trend: 'up' },
    ...
    { clinician: 'R. Torres, LCPC', completed: 5, avgDays: 1.0, sigRate: '100%', score: 98, trend: 'up' },
  ];
  return (
    <div className="space-y-5">
